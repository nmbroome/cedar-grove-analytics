...
import { Save, Plus, Calendar, Users, Target, CheckCircle, AlertCircle } from 'lucide-react';
import { doc, getDoc, updateDoc } from 'firebase/firestore';
import { db, waitForAuth } from '@/firebase/config';

const UtilizationTargetsTab = ({ users, usersLoading }) => {
